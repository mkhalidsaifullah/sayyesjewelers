		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 col-xs-5 logo">
					<a href="../index.php"><img src="../../images/logo.PNG" class="img-responsive" style="float:left;" alt=""/></a><img src="../../images/ad_banner.jpg" class="img-responsive" alt="" style="float:right;" />
				</div>
